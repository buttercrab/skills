...
- `precedence`: ["Outer owner for standalone read-only technical audits.","Inside Align or Goal, supplies the evidence lens without creating a second outer workflow."]
- `legal_compositions`: [{"route":"front-agent-orchestration","relation":"gateway"},{"route":"execute-goal-loop","relation":"overlay"},{"route":"brief-linked-evidence","relation":"content-owner"},{"route":"propagate-contract-changes","relation":"mechanics"},{"route":"refactor-by-invariant","relation":"mechanics"}]
