...
EXPECTED = {
    ...
    "mine-history-tool-landscapes": {
        "SKILL.md",
        "agents/openai.yaml",
        "references/capability-reduction-v3.schema.json",
        "references/capability-reduction.md",
        "references/history-evidence-v1.schema.json",
        "references/history-index-v4.schema.json",
        "references/history-publication-v3.schema.json",
        "references/history-source-contract.md",
        "references/history-sources-v4.schema.json",
        "references/history-v4-specification.md",
        "references/semantic-observation-ledger-v2.schema.json",
        "scripts/history_v4.py",
        "scripts/index_agent_history.py",
        "scripts/normalize_claude_history.py",
        "scripts/normalize_codex_history.py",
        "scripts/strict_json.py",
        "scripts/validate_capability_reduction.py",
        "scripts/validate_history_evidence.py",
        "scripts/validate_history_v4.py",
        "tests/test_capability_reduction.py",
        "tests/test_history_pipeline.py",
        "tests/test_history_v4_conformance.py",
    },
}
